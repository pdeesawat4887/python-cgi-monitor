...
if __name__ == '__main__':
    ...
    DIRECTORY = '/Applications/XAMPP/xamppfiles/htdocs/python/python-cgi-monitor/tuesdya-monday-pdf-report/'
    probe_report = PDFProbe('Probe', DIRECTORY+'Probe.pdf', 'both_logo.png')
    service_report = PDFService('Service', DIRECTORY+'Service.pdf', 'both_logo.png')
    log_report = PDFLogging('Logging Event', DIRECTORY+'Log.pdf', 'both_logo.png')
