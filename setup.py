...
setup(
    name='python-cgi-monitor',
    version='',
    packages=['venv.lib.python2.7.distutils', 'venv.lib.python2.7.encodings', 'venv.lib.python2.7.site-packages.dns',
              'venv.lib.python2.7.site-packages.dns.rdtypes', 'venv.lib.python2.7.site-packages.dns.rdtypes.IN',
              'venv.lib.python2.7.site-packages.dns.rdtypes.ANY', 'venv.lib.python2.7.site-packages.pip',
              ...
              'venv.lib.python2.7.site-packages.mysql', 'venv.lib.python2.7.site-packages.mysql.connector',
              'venv.lib.python2.7.site-packages.mysql.connector.django',
              'venv.lib.python2.7.site-packages.mysql.connector.fabric',
              'venv.lib.python2.7.site-packages.mysql.connector.locales',
              'venv.lib.python2.7.site-packages.mysql.connector.locales.eng', 'venv.lib.python2.7.site-packages.wheel',
              'venv.lib.python2.7.site-packages.wheel.tool', 'venv.lib.python2.7.site-packages.wheel.signatures',
              'venv.lib.python2.7.site-packages.pytube', 'venv.lib.python2.7.site-packages.pytube.contrib',
              ...
              'venv.lib.python2.7.site-packages.firebase', 'venv.lib.python2.7.site-packages.requests',
              ...
              'venv.lib.python2.7.site-packages.setuptools.command', 'venv.lib.python2.7.site-packages.pythonwhois',
              ...
              'venv.lib.python2.7.site-packages.pkg_resources._vendor.packaging', 'usage', 'playground.py'],
    url='',
    license='',
    author='pacharapoldeesawat',
    author_email='',
    description=''
)
